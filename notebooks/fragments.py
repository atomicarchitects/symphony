...
workdirs = {
    # "nn_1": "/home/songk/potato/songk/silica_fragments_capped/nn/max_targets_1/",
    "nn_4": "/home/songk/potato/songk/silica_fragments/nn/max_targets_4/",
    # "radius_1": "/home/songk/potato/songk/silica_fragments_capped/radius/max_targets_1/",
    # "radius_4": "/home/songk/potato/songk/silica_fragments_capped/radius/max_targets_4/",
}
...
for frag_method in workdirs:
    ...
    for graph in tqdm.tqdm(dataset.as_numpy_iterator()):
        num_targets[frag_method].append(jnp.sum(graph.globals.target_position_mask))
import pickle
