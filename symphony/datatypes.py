...
class ReceiverPredictions(NamedTuple):
    receivers: jnp.ndarray  # [n_receivers] int array
    radial_logits_neighbors: jnp.ndarray  # [n_receivers] float array
    angular_logits_neighbors: jnp.ndarray  # [n_receivers] float array
