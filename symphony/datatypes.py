...
class FragmentsNodes(NamedTuple):
    ...
    target_positions: jnp.ndarray  # [n_node, max_targets_per_graph, 3] float array (only for training)
    target_position_mask: jnp.ndarray  # [n_node, max_targets_per_graph] bool array (only for training)
