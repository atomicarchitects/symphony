...
class MiniProteinDataset(datasets.InMemoryDataset):
    """MiniProtein dataset (https://www.nature.com/articles/s41586-022-04654-9)."""
    ...
    def atoms_to_species() -> Dict[str, int]:
        mapping = {}
        amino_acid_abbr = MiniProteinDataset.get_amino_acids()
    ...
    def get_species() -> List[str]:
        return MiniProteinDataset.get_amino_acids() + ["C", "CA", "N", "X"]
...
def load_cath(
    ...
    with open(scaffolds_path, "r") as scaffolds_file:
        for mol_file in scaffolds_file.readlines():
            ...
            for i in range(len(fragment_starts) - 1):
                ...
                try:
                    ...
                    species = np.vectorize(MiniProteinDataset.atoms_to_species().get)(elements)
