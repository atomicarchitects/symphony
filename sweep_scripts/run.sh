...
embedder=nequip
# train=1000
workdir=/data/NFS/potato/songk/spherical-harmonic-net/workdirs/"$dataset"_jan19/e3schnet_and_"$embedder"/$mode/max_targets_$max_targets_per_graph
...
CUDA_VISIBLE_DEVICES=$cuda python -m symphony \
    ...
    --config.generation.start_seed=100 \
