...
def get_config() -> ml_collections.ConfigDict:
    ...
    solid_id = 1  # 0 = tetrahedron, 1 = octahedron, 2 = cube, 3 = icosahedron, 4 = dodecahedron
    config.train_solids = [solid_id]
    config.val_solids = [solid_id]
    config.test_solids = [solid_id]
